...
int GetLexTokenDataTypeDesc(int nDesc, char szBuffer[], int nBufferSize) {
	...
	switch (nDesc) {
	case LEXTOKEN_DATATYPE_UNDEFINED:
		strcpy(szBuffer, "NULL");
		break;
	case LEXTOKEN_DATATYPE_TINY:
		strcpy(szBuffer, "TINY");
		break;
	case LEXTOKEN_DATATYPE_SHORT:
		strcpy(szBuffer, "SHORT");
		break;
	case LEXTOKEN_DATATYPE_LONG:
		strcpy(szBuffer, "LONG");
		break;
	case LEXTOKEN_DATATYPE_INT24:
		strcpy(szBuffer, "INT24");
		break;
	case LEXTOKEN_DATATYPE_LONGLONG:
		strcpy(szBuffer, "LONGLONG");
		break;
	case LEXTOKEN_DATATYPE_DECIMAL:
		strcpy(szBuffer, "DECIMAL");
		break;
	case LEXTOKEN_DATATYPE_FLOAT:
		strcpy(szBuffer, "FLOAT");
		break;
	case LEXTOKEN_DATATYPE_DOUBLE:
		strcpy(szBuffer, "DOUBLE");
		break;
	case LEXTOKEN_DATATYPE_TIMESTAMP:
		strcpy(szBuffer, "TIMESTAMP");
		break;
	case LEXTOKEN_DATATYPE_DATE:
		strcpy(szBuffer, "DATE");
		break;
	case LEXTOKEN_DATATYPE_TIME:
		strcpy(szBuffer, "TIME");
		break;
	case LEXTOKEN_DATATYPE_DATETIME:
		strcpy(szBuffer, "DATETIME");
		break;
	case LEXTOKEN_DATATYPE_YEAR:
		strcpy(szBuffer, "YEAR");
		break;
	case LEXTOKEN_DATATYPE_STRING:
		strcpy(szBuffer, "STRING");
		break;
	case LEXTOKEN_DATATYPE_VAR_STRING:
		strcpy(szBuffer, "VAR_STRING");
		break;
	case LEXTOKEN_DATATYPE_BLOB:
		strcpy(szBuffer, "BLOB");
		break;
	case LEXTOKEN_DATATYPE_SET:
		strcpy(szBuffer, "SET");
		break;
	case LEXTOKEN_DATATYPE_ENUM:
		strcpy(szBuffer, "ENUM");
		break;
	case LEXTOKEN_DATATYPE_NULL:
		strcpy(szBuffer, "NULL");
		break;
	case LEXTOKEN_DATATYPE_TEXT:
		strcpy(szBuffer, "TEXT");
		break;
	case LEXTOKEN_DATATYPE_CHAR:
		strcpy(szBuffer, "CHAR");
		break;
	case LEXTOKEN_DATATYPE_VARCHAR:
		strcpy(szBuffer, "VARCHAR");
		break;
	case LEXTOKEN_DATATYPE_DEFAULT:
		strcpy(szBuffer, "VARCHAR");
		break;
	default:
		strcpy(szBuffer, "VARCHAR");
