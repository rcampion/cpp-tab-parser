 ...
 ***************************************************************************/
/*
ZLexParser::ZLexParser(std::string &s) {
	//todo: buffer is empty! whose responsibility is it to fill it?
	// also 
	init();
	...
	if(s.length() > 0) {
		m_sTextBuffer = s;
		m_eParseStatus = prepareBufferFromText();
	}
	else
	{
		m_eParseStatus = E_BufferEmpty;
 ...
 ***************************************************************************/
/*
ZLexParser::ZLexParser(ZLexFileBuffer *zbuf) {
	//todo: buffer is empty! whose responsibility is it to fill it?
	// also 
	init();
	...
	if(zbuf->getSize() > 0) {
		m_sTextBuffer = ""; //we are using a char* based buffer, nullify this
		m_pLexCharBuffer = NULL; //we are using a char* based buffer, initialize
		m_eParseStatus = prepareBufferFromBinary(zbuf);
	}
	else
	{
		m_eParseStatus = E_BufferEmpty;
 ...
 ***************************************************************************/
/*
ZLexParser::ZLexParser(std::vector v) {
 ...
 ***************************************************************************/
/*
StatusCode ZLexParser::prepareBufferFromText() {
 ...
 ***************************************************************************/
/*
LexError ZLexParser::doFileLineParse() {
  ...
  {
		m_eParseStatus = E_Exception;
		return rc;
  }

  if(rc != E_LEX_OK) {
    m_eParseStatus = E_ParserError;
		return rc;
	}
 ...
 ***************************************************************************/
/*
LexError ZLexParser::doHdrLineParse() {
  LexError rc       = E_LEX_OK;
 ...
 ***************************************************************************/
/*
LexError ZLexParser::doDataLineParse() {
  LexError rc       = E_LEX_OK;
 ...
 ***************************************************************************/
/*
StatusCode ZLexParser::fillLexBufferFromFile(LEXFILEBUFFER* pLexFileBuf, const char* fname, int& byteCounter)
{
 ...
 ***************************************************************************/
/*
StatusCode ZLexParser::fillLexBufferFromBuf(LEXFILEBUFFER* pLexFileBuf, const char* inputBuffer, int& byteCounter)
{
	StatusCode retval = E_NoError;
	size_t byteCount = 0;
	int	nextChar = 0;
 ...
 ******************************************************************************/
/*
StatusCode ZLexParser::fileBufferInit(LEXFILEBUFFER* fb, int size)
{
	StatusCode retval = E_NoError;
 ...
 ******************************************************************************/
/*
StatusCode ZLexParser::fileBufferFree(LEXFILEBUFFER* fb)
{
	StatusCode retval = E_NoError;
	if (fb->buf != (char*)NULL)
	{
 ...
 ******************************************************************************/
/*
StatusCode ZLexParser::fileBufferPutChar(LEXFILEBUFFER* fb, char byte)
{
	StatusCode retval = E_NoError;
 ...
 ******************************************************************************/
/*
StatusCode ZLexParser::fileBufferEnlarge(LEXFILEBUFFER* fb)
{
	char* newbuf;
 ...
 ******************************************************************************/
/*
bool ZLexParser::fileBufferCanRead(LEXFILEBUFFER* fb)
{
	bool	retval;
 ...
 ******************************************************************************/
/*
FILE* ZLexParser::fileOpenExt(const char* name)
{
	FILE* fp;
 ...
 ***************************************************************************/
/*
ZLexToken* ZLexParser::initLexTokenList(void) { 	
