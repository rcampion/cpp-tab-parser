/****************************************************************************
*
* TabHdrLineLexer.l  -parser definition.
*
* --------------------- 
* flex info:
* flex version 2.5.4  
...
* IDE settings
* DEBUG
* bison -y -d --debug -v --verbose -p zHdr_ -o.\tab\BisonTabHdrLineParser.cpp .\tab\TabHdrLineParser.y
* RELEASE
* bison -y -d -p zHdr_ -o.\tab\BisonTabHdrLineParser.cpp .\tab\TabHdrLineParser.y
* MAKEFILE
* bison -y -d -p zHdr_ -o.\tab\BisonTabHdrLineParser.cpp .\tab\TabHdrLineParser.y
* ---------------------
